...
from phyanim import EventCondition, PhysicsAnimation, PhysicsEvent, PhysicsSegment, PointParticle, StateTransition
...
if __name__ == "__main__":
    ...
    end_event = PhysicsEvent("end_event", condition=EventCondition(expression="t - t_start - 1", terminal=True, direction=1), transition=StateTransition(name="default", equations={}))
